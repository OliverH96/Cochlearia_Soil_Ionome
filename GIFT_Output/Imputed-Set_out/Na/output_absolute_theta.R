...
png("C://Users/Oliver/Desktop/UoN/Individual_project/GWAS_out/impute_out/Na/output_absolute_theta.png", bg = "white", width = 9.75, height = 3.25, units = "in", res = 1200, pointsize = 4)
...
write.csv(GWAS_result, "C://Users/Oliver/Desktop/UoN/Individual_project/GWAS_out/impute_out/Na/top_output.csv", row.names=FALSE)
...
saveWidget(html_file, "C://Users/Oliver/Desktop/UoN/Individual_project/GWAS_out/impute_out/Na/output_absolute_theta.html", selfcontained = T)
