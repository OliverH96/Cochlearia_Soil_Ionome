...
png("C://Users/Oliver/Desktop/UoN/Individual_project/GWAS_out/impute_out/Ni/output_absolute_theta.png", bg = "white", width = 9.75, height = 3.25, units = "in", res = 1200, pointsize = 4)
...
saveWidget(html_file, "C://Users/Oliver/Desktop/UoN/Individual_project/GWAS_out/impute_out/Ni/output_absolute_theta.html", selfcontained = T)
