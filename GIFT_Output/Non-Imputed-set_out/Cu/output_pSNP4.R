...
library("htmlwidgets")
#library("manhattanly")
GWAS_result1 <- read.csv("C://Users/Oliver/Desktop/UoN/Individual_project/GWAS_out/no_impute_out/Cu/output.csv")
...
png("C://Users/Oliver/Desktop/UoN/Individual_project/GWAS_out/no_impute_out/Cu/output_pSNP4.png", bg = "white", width = 9.75, height = 3.25, units = "in", res = 1200, pointsize = 4)
...
#saveWidget(html_file, "C://Users/Oliver/Desktop/UoN/Individual_project/GWAS_out/no_impute_out/Cu/output_pSNP4.html", selfcontained = T)
