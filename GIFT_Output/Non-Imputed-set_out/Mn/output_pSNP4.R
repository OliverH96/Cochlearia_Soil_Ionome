...
library("htmlwidgets")
#library("manhattanly")
GWAS_result1 <- read.csv("output.csv")
...
png("output_pSNP4.png", bg = "white", width = 9.75, height = 3.25, units = "in", res = 1200, pointsize = 4)
...
#saveWidget(html_file, "output_pSNP4.html", selfcontained = T)
