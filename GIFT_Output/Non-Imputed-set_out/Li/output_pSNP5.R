...
png("C://Users/Oliver/Desktop/UoN/Individual_project/GWAS_out/no_impute_out/Li/output_pSNP5.png", bg = "white", width = 9.75, height = 3.25, units = "in", res = 1200, pointsize = 4)
...
#saveWidget(html_file, "C://Users/Oliver/Desktop/UoN/Individual_project/GWAS_out/no_impute_out/Li/output_pSNP5.html", selfcontained = T)
